...
export default function ChallengeFormat() {
    return (
        <div className='challenge__format__container'>
            ...
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam praesentium libero sapiente est ab tenetur doloribus molestiae aspernatur facilis doloremque eveniet, voluptatem veritatis similique dolores modi dolor quos pariatur fugit..
            </p>
            <p>
